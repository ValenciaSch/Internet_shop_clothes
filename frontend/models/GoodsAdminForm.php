...
class Goods extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'id_brands', 'id_category1', 'id_category2', 'id_category3', 'img', 'id_color', 'img_clothers', 'id_size', 'img_slide', 'short_description', 'full_description',  'price'], 'required'],
            ...
            [['name', 'img', 'id_color', 'img_clothers', 'id_size', 'img_slide'], 'string', 'max' => 255],
             [['img_clothers', 'img_slide',], 'file', 'skipOnEmpty' => false, 'extensions' => ' jpg'],
        ];
    }
