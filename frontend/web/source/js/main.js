var VigoShop = {
    ...
    jQuery('.footer-form #send_message').click(function(e){
        ...
        //Реагирование на изменения цвета и размера////
       
        $("input[type='checkbox']").change(function () { 
           // alert("kkk");
        jQuery('#refreshButtonSize_Color').click();
        });
        
        
         //Реагирование на изменения селектора(выбор сортировки: по возрастанию или убыванию цены)////
          $("select[name=sort-by]").change(function () { 
          // alert("kkk");
        jQuery('#refreshButtonSort').click();
        });
       ...
       this.initFlexsliders();
        ...
        jQuery('.range-slider').slider({
            ...
            formater : function(val) {
                var value = jQuery('<b></b>').text(val+" грн.");
                if(index == 0) {
                ...
                jQuery('.slider-handle').each(function(index) {
                    var value = jQuery('<b></b>').text(ev.value[index]+" грн.");
                    jQuery(this).html(value);
                   
                     jQuery('#refreshButtonPrice').click();
                   // jQuery('#refreshButtonPrice').mouseup();
